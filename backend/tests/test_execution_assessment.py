...
from app.modules.code.execution_assessment import assess_execution
...
def _candidate(*, datasets=None, metrics=None, text="Evaluate an algorithm"):
    return {
        ...
        "problem": text,
        "proposedMethod": text,
        "requiredExperiments": [{"datasets": datasets or [], "metrics": metrics or []}],
    }
